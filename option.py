...
parser.add_argument('--pseudo',type=str,  default='Unsup_labels/UCF_unsup_labels_i3d_varT.npy', help='pseudo labels')
...
parser.add_argument('--pseudofile',type=str,  default='UCF_unsup_labels_i3d_varT', help='ground truth file')
