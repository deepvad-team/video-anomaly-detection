...
parser.add_argument('--pseudo',type=str,  default='Unsup_labels/UCF_meta_pseudo_labels.npy', help='pseudo labels')
...
parser.add_argument('--pseudofile',type=str,  default='UCF_meta_pseudo_labels', help='ground truth file')
